...
4. `src/backend/app/db/models/dive_site.py`
5. `src/backend/ruff.toml`
6. `src/backend/mypy.ini`
...
4. `src/backend/app/db/models/__init__.py` — Export Destination, DiveSite
5. `src/backend/alembic/env.py` — Import Base.metadata, all models
6. `src/backend/tests/unit/db/test_models.py` — Test Destination, DiveSite imports
