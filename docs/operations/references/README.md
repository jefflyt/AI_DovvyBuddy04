...
- **Technical Spec:** [../../architecture/specification.md](../../architecture/specification.md) — External integrations
- **Decisions:** [../../architecture/decisions/](../../architecture/decisions/) — Why we chose specific services
- **Plans:** [../../archive/plans/](../../archive/plans/) — Where external APIs are integrated
