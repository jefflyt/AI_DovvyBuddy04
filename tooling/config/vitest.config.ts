...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      ...
      'apps/web/src/features/chat/components/__tests__/TripLeadForm.test.tsx',
      'apps/web/src/features/chat/components/__tests__/TrainingLeadForm.test.tsx',
      'apps/web/src/features/chat/components/__tests__/LeadCaptureModal.test.tsx',
