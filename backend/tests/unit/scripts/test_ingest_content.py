...
@pytest.mark.asyncio
async def test_ingest_file_success(mock_chunk_text, mock_parse, mock_hash):
...
@patch("scripts.ingest_content.chunk_text")
@pytest.mark.asyncio
async def test_ingest_file_incremental_skip(mock_chunk_text, mock_get_hash, mock_calc_hash):
...
@patch("scripts.ingest_content.chunk_text")
@pytest.mark.asyncio
async def test_ingest_file_dry_run(mock_chunk_text, mock_parse, mock_hash):
