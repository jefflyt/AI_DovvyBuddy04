...
describe.skip('API Client Integration Tests', () => {
  ...
  describe('Chat API', () => {
    ...
    it('should handle validation error (message too long)', async () => {
      ...
      await expect(client.chat({ message: longMessage })).rejects.toThrow(
        ApiClientError
      )
  ...
  describe('Session API', () => {
    ...
    it('should handle session not found (404)', async () => {
      ...
      await expect(client.getSession(invalidSessionId)).rejects.toThrow(
        ApiClientError
      )
  ...
  describe('Error Handling', () => {
    ...
    it('should handle network errors gracefully', async () => {
      ...
      await expect(badClient.chat({ message: 'Test' })).rejects.toThrow(
        ApiClientError
      )
