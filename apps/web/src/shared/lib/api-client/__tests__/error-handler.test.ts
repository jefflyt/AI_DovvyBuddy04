...
describe('ApiClientError', () => {
  ...
  it('should identify validation errors', () => {
    const error = new ApiClientError('VALIDATION_ERROR', 400, 'Invalid input')
  ...
  it('should identify retryable errors (5xx)', () => {
    ...
    const error400 = new ApiClientError('VALIDATION_ERROR', 400, 'Bad request')
  ...
  it('should not retry timeout errors', () => {
    const error = new ApiClientError('TIMEOUT', 408, 'Request timeout')
