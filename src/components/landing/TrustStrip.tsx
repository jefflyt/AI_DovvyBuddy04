...
const items = [
    {
        ...
        description: 'Answers cite official certification standards and dive site data',
    },
    {
        icon: Shield,
    ...
    },
    {
        ...
        description: 'Always consult certified instructors and medical professionals',
    },
];
