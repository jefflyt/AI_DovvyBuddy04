...
const ERROR_MESSAGES: Record<ApiErrorCode, string> = {
  ...
  LLM_API_ERROR: 'Our AI service is temporarily unavailable. Please try again in a moment.',
  LLM_SERVICE_UNAVAILABLE: 'Our AI service is temporarily unavailable. Please try again in a moment.',
  ADK_UNAVAILABLE: 'Our AI service is temporarily unavailable. Please try again in a moment.',
  DATABASE_ERROR: 'Unable to process your request. Please try again.',
  SESSION_NOT_FOUND: 'Your session has expired. Please start a new conversation.',
