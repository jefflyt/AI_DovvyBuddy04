...
title: Agency Comparison (Template for RAG)
description: 'Reference information about Agency Comparison (Template for RAG).'
scope: comparison
...
- If a user’s question is about what they personally should do next, respond with:
  - The prerequisite mapping (if known)
  - A request to verify with the dive center/instructor for current standards
...
- BSAC Ocean/Sport/Dive Leader definitions (official)
- WRSTC member lists / standards references

Populate each section with short, source-backed bullets only.
