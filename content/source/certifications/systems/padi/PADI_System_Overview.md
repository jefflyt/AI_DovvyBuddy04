...
description: 'Reference information about PADI Certification System Overview.'
layer: system
agency: PADI
scope: system_overview
lifetime_valid: true
globally_recognized: true
wrstc_aligned: true
...
- **Digital Verification**: Certifications can be verified electronically through PADI systems
...
- Safety-focused and experience-building certifications
- Recognition ratings based on training and logged experience
...
- Technical and freediving pathways for advanced disciplines

Divers may pursue specialties at various stages, provided prerequisites are met.
