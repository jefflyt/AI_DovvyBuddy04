...
title: 'OW_Training_Structure_and_Skills'
description: 'Reference information about OW_Training_Structure_and_Skills.'
...
cert_level: OW
scope: recreational
training_component: structure_and_skills
minimum_age: 10
...
All components must be completed to certification standards.
...
- Mask clearing and mask removal/replacement
- Buoyancy control using the BCD and breathing
- Regulator recovery techniques
- Underwater swimming and basic navigation
- Emergency procedures for out-of-air situations
- Buddy system and communication

Training is conducted in shallow, pool-like conditions.
...
Each dive typically lasts 20–30 minutes, depending on conditions and air consumption.
...
- Complete all four open water dives
- Meet medical and administrative requirements
...
Courses may be conducted intensively or spread across multiple weeks.
