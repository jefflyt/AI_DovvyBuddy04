...
title: 'AOW_Overview_and_Privileges'
description: 'Reference information about AOW_Overview_and_Privileges.'
...
A minimum Open Water Diver certification (or equivalent) is required.
...
- It aligns with World Recreational Scuba Training Council (WRSTC) standards

Dive operators may require a refresher or checkout dive if a diver has not been active recently.
...
- Enroll in Rescue Diver training and additional specialty courses
- Continue along the professional training pathway
...
To dive deeper than 30 meters, additional training such as the Deep Diver specialty is required.
...
- Forms part of the pathway toward professional-level training such as Divemaster
