...
title: 'AOW_Training_Structure_and_Mandatory_Dives'
description: 'Reference information about AOW_Training_Structure_and_Mandatory_Dives.'
...
cert_level: AOW
scope: recreational
training_component: structure_and_mandatory_dives
minimum_age: 12
...
- Specialty-specific knowledge related to selected adventure dives
...
Three additional adventure dives are selected from approved elective options.
...
- Establishing turn pressures and emergency procedures
- Using dive computers for deep dive planning
...
- Navigation patterns such as reciprocal and square patterns
- Relocating dive sites and returning to exit points
- Basic underwater map-making
