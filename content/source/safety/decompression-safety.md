...
description: 'Reference information about Decompression Safety.'
...
Decompression is the process of safely releasing nitrogen absorbed by your body during a dive. Proper decompression management is **critical** to prevent decompression sickness (DCS), also known as "the bends."
...
4. These bubbles cause decompression sickness

**Key Principle:** Ascend slowly enough for nitrogen to exit safely through your lungs, not form bubbles in your body.

## No-Decompression Limits (NDL)

No-decompression diving means you can ascend directly to the surface (with safety stop) without mandatory decompression stops.
...
- Altitude, cold water, and other factors reduce NDLs
...
4. **Conservative settings** - Use if diving multiple days or at altitude
5. **Battery maintenance** - Replace before dive trips
...
- First line of defense against DCS
...
- If computer doesn't require it, optional

## Repetitive Diving

Multiple dives in one day require extra caution:
...
- Review dive plan for next dive
...
- Ensure full 12+ hours surface interval overnight
- Consider nitrox for multi-day diving
...
- Cardiac symptoms
- Life-threatening - immediate treatment required
...
- Repetitive deep dives
- Saw-tooth profiles (up and down)
- Cold water exposure
- Strenuous diving
...
- Older age (slower circulation)
- Previous DCS history
- Patent Foramen Ovale (PFO) - heart defect
...
1. **Stay well within NDLs**
   - End dive with 10+ minutes NDL remaining
   - Don't push limits

2. **Proper ascent rate**
   - Maximum 18m/60ft per minute
   - Slower is better (9-12m/min ideal)

3. **Always do safety stops**
   - 3-5 minutes at 5m (15ft)
   - Even on shallow dives

4. **Optimal dive profiles**
   - Deepest dive first
   - Adequate surface intervals
   - Avoid yo-yo diving (up and down)

5. **Hydration**
   - Drink water before, between, and after dives
   - Urine should be clear/light colored
...
6. **Physical condition**
   ...
   - Don't dive if ill
   - Maintain fitness
   - Avoid heavy exercise before/after

7. **Conservative computer settings**
   - Use when diving multiple days
   - Consider +1 or +2 conservatism setting
   - Some computers have "repetitive dive" modes

8. **Post-dive precautions**
   - No flying for 12-24 hours after diving
   - Avoid hot tubs/saunas
   - Don't exercise heavily
   - Stay hydrated

### DCS Treatment: Immediate Response

**If you suspect DCS in yourself or buddy:**

1. **Stop all activity immediately**
2. **Call emergency services**
   - DAN Emergency Hotline: +1-919-684-9111
   - Local emergency: 911 (USA), 112 (EU), etc.

3. **Administer 100% oxygen**
   - If available and you're trained
   - Use non-rebreather mask
   - Highest flow rate possible

4. **Position patient**
   - Lying down, on left side if unconscious
   - Do NOT place head-down (old myth)

5. **Keep patient calm and warm**
   - Reassure them
   - Light blanket if cold
   - No food or drink if serious symptoms

6. **Monitor vitals**
   - Breathing, pulse, consciousness
   - Be ready to perform CPR if needed

7. **Arrange hyperbaric chamber transport**
   - DAN will coordinate
   - May require helicopter evacuation
   - Do NOT attempt to dive again (will make it worse)

8. **Document everything**
   - Dive profiles
   - Symptoms and timeline
   - Treatment given
   - This info helps medical staff

**Critical:** Even if symptoms improve, STILL seek medical evaluation. Symptoms can return or worsen.
...
- Reduced post-dive fatigue (anecdotal)
...
## Special Decompression Considerations
...
- Acclimatization period before diving
...
- Longer safety stops
- Proper thermal protection essential
...
- Skydiving
- Hot air balloons
- Driving to high altitude (mountain passes)
...
- Plan deepest dive first when doing multiples
- Stay hydrated before, during, and after diving
- Use conservative computer settings
...
- Dive immediately after drinking alcohol
- Exercise heavily after diving
- Fly within 12 hours of diving
- Ignore DCS symptoms ("hoping they'll go away")
